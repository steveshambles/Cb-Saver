...
V0.26-2:
--------
Updated blog link to new post on new blog.
Added Github link to source code.
Corrected a few quote marks.
...
def visit_blog(stray):
    ...
    web.open('https://pyshambles.blogspot.com/2020/09/python-systray-clipboard-manager.html')

def donate_me(stray):
    web.open('https://paypal.me/photocolourizer')

def github(stray):
    web.open('https://github.com/steveshambles/Cb-Saver')
...
hover_text = 'Clipboard Saver V0.26-2'
